;define([
	...
	'layer'
		...
		var Studycenter = Backbone.View.extend({
			el : 'body',
			template : _.template($('#template-questions-video').html()),
			events : {
			...
			init : function(){
				this.exerciseFilenameAjax(function(data){
					var templateHtml = $('#template-questions-video-cards').html();
	    ...
	    actionTaskProgress : function(){
	      ...
	      // taskProgressData.taskStudyTotalTime = taskStudyTotalTime;
				...
				if(feedback){
					...
					feedback.on('click','.pop-button-confirm',function(){
	    				...
	    				var jsonName = {
							...
							addDom += 'data-type="knowledge" data-sort="'+sort+'" data-exercise-id="'+ CAICUI.render.exerciseId +'" data-title="'+ CAICUI.render.knowledgepointName+'" ';
			...
			createGuide : function(){
				var templateHtml = $('#template-questions-video-guide').html();
				var addHtml = CAICUI.iGlobal.getTemplate(templateHtml);
			...
			addDOMNidExerciseDetail:function(data){
				...
				var templateHtml = $('#template-questions-video-content').html();
				var addHtml = CAICUI.iGlobal.getTemplate(templateHtml,{
					'item' : exerciseData
				});
		  ...
		  removeAnimate : function(callback){
			...
			questionsLoaderContent : function(){
				var templateHtml = $('#template-questions-video-loader-content').html();
				var addHtml = CAICUI.iGlobal.getTemplate(templateHtml);
