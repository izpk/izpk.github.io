...
$.dialog = function(div, settings) {
	...
	this.init = function() {
		...
		// var parentBody = parent.$('body .main');
		// if($.joverlay.length == 0) {
		// 	$.joverlay = parentBody.append($('<div class="dialog-overlay" id="dialog_overlay" ref="0" unselectable="on" onselect="return false;"></div>').hide());
		// }
