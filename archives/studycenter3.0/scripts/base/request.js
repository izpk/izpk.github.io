...
define([
    ...
    var request = {
        ajax: function(args) {
            ...
            var importantApi = {
                'http://api.caicui.com/api/v2.1/learning/noActivecourse': 1,
                'http://api.caicui.com/api/v2/course/active': 1,
                'http://api.caicui.com/api/v2.1/learning/learningcourse': 1,
                'http://api.caicui.com/api/v2.1/learning/expirationcourse': 1,
                'http://api.caicui.com/api/v2.1/study/coursestatus': 1,

                'http://api.caicui.com/api/v2.1/course/courseBaseInfoe': 1,
                'http://api.caicui.com/api/v2.1/course/chapterandtaskcount': 1,
                'http://api.caicui.com/api/v2.1/course/courseDetail': 1,
                'http://api.caicui.com/api/v2/logout': 1
            }
